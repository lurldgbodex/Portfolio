package tech.sgcor.portfolio.project.service;
...
import tech.sgcor.portfolio.project.repository.ProjectDetailsRepository;
import tech.sgcor.portfolio.project.repository.ProjectRepository;
...
public class ProjectService {
    ...
    public Project createProject(ProjectDto request) {
        ...
        project.setImageLink(request.getImage_link());
    ...
    public CustomResponse updateProject(long id, ProjectUpdate request) {
        ...
        boolean hasNonBlankField = Stream.of(
                ...
                Objects.toString(request.getImage_link(), ""),
        ...
        project.setDescription(SharedService.isNotBlank(request.getDescription())
                ? request.getDescription() : project.getDescription());
        project.setImageLink(SharedService.isNotBlank(request.getImage_link())
                ? request.getImage_link() : project.getImageLink());
